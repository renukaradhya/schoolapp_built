...
$.AdminLTE.layout = {
  ...
  fix: function () {
    ...
    var neg = $('#header').outerHeight() + $('.main-footer').outerHeight();
...
$.AdminLTE.tree = function (menu) {
  ...
  $("li a", $(menu)).click(function (e) {
    ...
    if (checkElement.is('.treeview-menu li')) { alert();
      $(this).addClass('active');
    }
    ...
    //slide the menu when other tabs are clicked
      ...
      if ($(this).is('.treeview-menu li a')) {
        ...
        //Close the menu
        $('.treeview-menu').slideUp('normal', function () {
          $('.treeview-menu').removeClass('menu-open');
          //Fix the layout in case the sidebar stretches over the height of the window
          //_this.layout.fix();
        });
        $('.treeview-menu').parent("li").removeClass("active");
      }
    }
