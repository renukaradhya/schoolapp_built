    ...
    angular.module('scrollable-table', [])
        .directive('scrollableTable', ['$timeout', '$q', '$parse', function ($timeout, $q, $parse) {
            return {
                ...
                template: '<div class="scrollableContainer" id="scrollId">' +
                ...
                controller: ['$scope', '$element', '$attrs', function ($scope, $element, $attrs) {
                    ...
                    function fixHeaderWidths() {
                        ...
                        if($element.find("thead th .th-inner:not(:has(.innerBox))").length) {
                            $element.find("thead th .th-inner:not(:has(.innerBox))").wrapInner('<div class="innerBox" ></div>');
                        }
                        ...
                        $element.find("table th .th-inner:visible").each(function (index, el) {
                            ...
                            if (!title) {
                                // ordinary column(not sortableHeader) has innerBox child div element that contained title string.
                                title = el.find(".title .ng-scope").html() || el.find(".innerBox").html();
                            }
