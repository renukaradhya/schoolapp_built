/**
 * Created by santhoshkumar.k on 02-02-2015.
 */
/**
 ...
 * https://github.com/angular-ui/angular/blob/master/src/pagination/pagination.js
 *
...
(function() {
            ...
            link: function dirPaginationControlsLinkFn(scope, element, attrs) {
                ...
                scope.$watch(function(){
                    if (scope.onPageChange) {
                        scope.onPageChange({resultedListLength : paginationService.getFilteredListLength(paginationId)});
                    }
                })
    ...
    module.filter('itemsPerPage', ['paginationService', function(paginationService,scope) {
        ...
        return function(collection, itemsPerPage, paginationId) {
            ...
            if (collection instanceof Array) {
                ...
                paginationService.setFilteredListLength(paginationId,collection.length);
                return collection;
            } else {
                return collection;
            }
    ...
    module.service('paginationService', function() {
        ...
        this.setFilteredListLength = function(instanceId,val) {
            instances[instanceId].resultedCollectionLength = val;
        };
        this.getFilteredListLength = function(instanceId) {
            return instances[instanceId].resultedCollectionLength;
        };
    });
